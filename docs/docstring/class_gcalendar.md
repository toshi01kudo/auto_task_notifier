...
:   
    ...
    `get(self, start_date: <module 'datetime' from '/opt/hostedtoolcache/Python/3.11.10/x64/lib/python3.11/datetime.py'> = datetime.datetime(2024, 11, 5, 10, 10, 11, 548361, tzinfo=datetime.timezone(datetime.timedelta(seconds=32400), 'JST')), prior_days: int = 30) ‑> list`
