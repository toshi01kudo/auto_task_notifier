...
:   
    ...
    `get(self, start_date: <module 'datetime' from '/opt/hostedtoolcache/Python/3.11.10/x64/lib/python3.11/datetime.py'> = datetime.datetime(2024, 11, 5, 10, 9, 44, 355912, tzinfo=datetime.timezone(datetime.timedelta(seconds=32400), 'JST')), prior_days: int = 30) ‑> list`
